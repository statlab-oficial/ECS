...
{[}Créditos:{]}{[}https://editora.uespi.br/index.php/editora/catalog/view/58/53/317-1{]}
...
dois tipos: \textbf{coleta direta} e \textbf{coleta indireta}.{]}

\begin{enumerate}
\def\labelenumi{\arabic{enumi})}
\tightlist
\item
  Coleta direta - obtida diretamente da fonte. Levantamento de registros
  (nascimentos, óbitos, notas fiscais, impostos, entre outros) ou
  coletados diretamente através de inquéritos, questionários etc. Esses
  dados são chamados de dados primários. Esta coleta pode ser
  classificada como:
\end{enumerate}
...
.content-box-red{[}
\protect\includegraphics[height=0.7em]{/tmp/RtmpaTnSKD/filee25b704d0c7b.pdf}
